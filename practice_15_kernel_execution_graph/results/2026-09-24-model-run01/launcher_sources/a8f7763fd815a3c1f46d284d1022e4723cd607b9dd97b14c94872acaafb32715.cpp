...
static void _launch(const char* kernelName, const void* func, rtStream_t stream, int gridX, int gridY, int gridZ, std::vector<std::vector<int64_t>> &tensorShapes, std::vector<int> &tensorKinds, void* arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, void* arg6, int32_t arg7, int32_t arg8, int32_t arg9, int32_t arg10) {
  ...
  auto launch_call = [=]() -> rtError_t {
    ...
    struct __attribute__((packed)) {
      ...
      void* arg0 __attribute__((aligned(8))); int32_t arg3 __attribute__((aligned(4))); int32_t arg4 __attribute__((aligned(4))); int32_t arg5 __attribute__((aligned(4))); void* arg6 __attribute__((aligned(8))); int32_t arg7 __attribute__((aligned(4))); int32_t arg8 __attribute__((aligned(4)));
      ...
      nullptr,
      nullptr,
      static_cast<void*>(arg0), static_cast<int32_t>(arg3), static_cast<int32_t>(arg4), static_cast<int32_t>(arg5), static_cast<void*>(arg6), static_cast<int32_t>(arg7), static_cast<int32_t>(arg8),
