...
static void _launch(const char* kernelName, const void* func, rtStream_t stream, int gridX, int gridY, int gridZ, std::vector<std::vector<int64_t>> &tensorShapes, std::vector<int> &tensorKinds, void* arg0, int32_t arg1, void* arg2, int32_t arg3, void* arg4, void* arg5, void* arg6, void* arg7, void* arg8, int32_t arg9, void* arg10, int32_t arg11) {
  ...
  auto launch_call = [=]() -> rtError_t {
    ...
    struct __attribute__((packed)) {
      ...
      void* arg0 __attribute__((aligned(8))); int32_t arg1 __attribute__((aligned(4))); void* arg2 __attribute__((aligned(8))); int32_t arg3 __attribute__((aligned(4))); void* arg8 __attribute__((aligned(8))); int32_t arg9 __attribute__((aligned(4))); void* arg10 __attribute__((aligned(8))); int32_t arg11 __attribute__((aligned(4)));
      ...
      nullptr,
      nullptr,
      static_cast<void*>(arg0), static_cast<int32_t>(arg1), static_cast<void*>(arg2), static_cast<int32_t>(arg3), static_cast<void*>(arg8), static_cast<int32_t>(arg9), static_cast<void*>(arg10), static_cast<int32_t>(arg11),
...
static PyObject* launch(PyObject* self, PyObject* args) {
  ...
  PyObject* _arg0;  int32_t _arg1;  PyObject* _arg2;  int32_t _arg3;  PyObject* _arg4;  PyObject* _arg5;  PyObject* _arg6;  PyObject* _arg7;  PyObject* _arg8;  int32_t _arg9;  PyObject* _arg10;  int32_t _arg11; 
  if(!PyArg_ParseTuple(
      args, "iiiKKOOOOOiOiOOOOOiOi",
...
{ auto tmp = _get_tensor_shape(_arg6); if (!tmp.empty()) tensorShapes.push_back(tmp); }
{ auto tmp = _get_tensor_shape(_arg7); if (!tmp.empty()) tensorShapes.push_back(tmp); }
{ auto tmp = _get_tensor_shape(_arg8); if (!tmp.empty()) tensorShapes.push_back(tmp); }
{ auto tmp = _get_tensor_shape(_arg10); if (!tmp.empty()) tensorShapes.push_back(tmp); }
  }
  ...
  DevicePtrInfo ptr_info0 = getPointer(_arg0, 0); if (!ptr_info0.valid) return NULL;; ; DevicePtrInfo ptr_info2 = getPointer(_arg2, 2); if (!ptr_info2.valid) return NULL;; ; DevicePtrInfo ptr_info4 = getPointer(_arg4, 4); if (!ptr_info4.valid) return NULL;; DevicePtrInfo ptr_info5 = getPointer(_arg5, 5); if (!ptr_info5.valid) return NULL;; DevicePtrInfo ptr_info6 = getPointer(_arg6, 6); if (!ptr_info6.valid) return NULL;; DevicePtrInfo ptr_info7 = getPointer(_arg7, 7); if (!ptr_info7.valid) return NULL;; DevicePtrInfo ptr_info8 = getPointer(_arg8, 8); if (!ptr_info8.valid) return NULL;; ; DevicePtrInfo ptr_info10 = getPointer(_arg10, 10); if (!ptr_info10.valid) return NULL;; ;
  _launch(kernelName, function, stream, gridX, gridY, gridZ, tensorShapes, tensorKinds, ptr_info0.dev_ptr, _arg1, ptr_info2.dev_ptr, _arg3, ptr_info4.dev_ptr, ptr_info5.dev_ptr, ptr_info6.dev_ptr, ptr_info7.dev_ptr, ptr_info8.dev_ptr, _arg9, ptr_info10.dev_ptr, _arg11);
  if (PyErr_Occurred()) {
    return NULL;
  }
