...
static void _launch(const char* kernelName, const void* func, rtStream_t stream, int gridX, int gridY, int gridZ, std::vector<std::vector<int64_t>> &tensorShapes, std::vector<int> &tensorKinds, void* arg0, void* arg1, void* arg2, void* arg3, void* arg4, void* arg5, void* arg6, int32_t arg7, int32_t arg8, int32_t arg9, int32_t arg10, int32_t arg11, int32_t arg12, int32_t arg13, int32_t arg14, int32_t arg15, int32_t arg16) {
  ...
  auto launch_call = [=]() -> rtError_t {
    ...
    struct __attribute__((packed)) {
      ...
      void* arg0 __attribute__((aligned(8))); void* arg1 __attribute__((aligned(8))); void* arg2 __attribute__((aligned(8))); void* arg3 __attribute__((aligned(8))); void* arg4 __attribute__((aligned(8))); void* arg5 __attribute__((aligned(8))); void* arg6 __attribute__((aligned(8))); int32_t arg8 __attribute__((aligned(4))); int32_t arg9 __attribute__((aligned(4))); int32_t arg11 __attribute__((aligned(4))); int32_t arg13 __attribute__((aligned(4))); int32_t arg15 __attribute__((aligned(4)));
      ...
      nullptr,
      nullptr,
      static_cast<void*>(arg0), static_cast<void*>(arg1), static_cast<void*>(arg2), static_cast<void*>(arg3), static_cast<void*>(arg4), static_cast<void*>(arg5), static_cast<void*>(arg6), static_cast<int32_t>(arg8), static_cast<int32_t>(arg9), static_cast<int32_t>(arg11), static_cast<int32_t>(arg13), static_cast<int32_t>(arg15),
...
static PyObject* launch(PyObject* self, PyObject* args) {
  ...
  PyObject* _arg0;  PyObject* _arg1;  PyObject* _arg2;  PyObject* _arg3;  PyObject* _arg4;  PyObject* _arg5;  PyObject* _arg6;  int32_t _arg7;  int32_t _arg8;  int32_t _arg9;  int32_t _arg10;  int32_t _arg11;  int32_t _arg12;  int32_t _arg13;  int32_t _arg14;  int32_t _arg15;  int32_t _arg16; 
  if(!PyArg_ParseTuple(
      args, "iiiKKOOOOOOOOOOOiiiiiiiiii",
      &gridX, &gridY, &gridZ, &stream, &function,
      &packedMetadata, &launch_metadata,
      &launch_enter_hook, &launch_exit_hook
      , &_arg0, &_arg1, &_arg2, &_arg3, &_arg4, &_arg5, &_arg6, &_arg7, &_arg8, &_arg9, &_arg10, &_arg11, &_arg12, &_arg13, &_arg14, &_arg15, &_arg16
      )
    ) {
    return NULL;
  }
...
{ auto tmp = _get_tensor_shape(_arg6); if (!tmp.empty()) tensorShapes.push_back(tmp); }
  ...
  _launch(kernelName, function, stream, gridX, gridY, gridZ, tensorShapes, tensorKinds, ptr_info0.dev_ptr, ptr_info1.dev_ptr, ptr_info2.dev_ptr, ptr_info3.dev_ptr, ptr_info4.dev_ptr, ptr_info5.dev_ptr, ptr_info6.dev_ptr, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14, _arg15, _arg16);
  if (PyErr_Occurred()) {
    return NULL;
  }
