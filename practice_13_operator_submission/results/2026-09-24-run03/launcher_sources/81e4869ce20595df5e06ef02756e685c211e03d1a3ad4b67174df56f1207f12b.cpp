...
static void _launch(const char* kernelName, const void* func, rtStream_t stream, int gridX, int gridY, int gridZ, std::vector<std::vector<int64_t>> &tensorShapes, std::vector<int> &tensorKinds, void* arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, void* arg6, int32_t arg7, int32_t arg8, int32_t arg9, int32_t arg10) {
  ...
  auto launch_call = [=]() -> rtError_t {
    ...
    struct __attribute__((packed)) {
      ...
      void* arg0 __attribute__((aligned(8))); int32_t arg1 __attribute__((aligned(4))); int32_t arg3 __attribute__((aligned(4))); int32_t arg4 __attribute__((aligned(4))); int32_t arg5 __attribute__((aligned(4))); void* arg6 __attribute__((aligned(8))); int32_t arg7 __attribute__((aligned(4))); int32_t arg8 __attribute__((aligned(4)));
      ...
      nullptr,
      nullptr,
      static_cast<void*>(arg0), static_cast<int32_t>(arg1), static_cast<int32_t>(arg3), static_cast<int32_t>(arg4), static_cast<int32_t>(arg5), static_cast<void*>(arg6), static_cast<int32_t>(arg7), static_cast<int32_t>(arg8),
...
static PyObject* launch(PyObject* self, PyObject* args) {
  ...
  PyObject* _arg0;  int32_t _arg1;  int32_t _arg2;  int32_t _arg3;  int32_t _arg4;  int32_t _arg5;  PyObject* _arg6;  int32_t _arg7;  int32_t _arg8;  int32_t _arg9;  int32_t _arg10; 
  if(!PyArg_ParseTuple(
      args, "iiiKKOOOOOiiiiiOiiii",
...
{ auto tmp = _get_tensor_shape(_arg6); if (!tmp.empty()) tensorShapes.push_back(tmp); }
  ...
  DevicePtrInfo ptr_info0 = getPointer(_arg0, 0); if (!ptr_info0.valid) return NULL;; ; ; ; ; ; DevicePtrInfo ptr_info6 = getPointer(_arg6, 6); if (!ptr_info6.valid) return NULL;; ; ; ; ;
  _launch(kernelName, function, stream, gridX, gridY, gridZ, tensorShapes, tensorKinds, ptr_info0.dev_ptr, _arg1, _arg2, _arg3, _arg4, _arg5, ptr_info6.dev_ptr, _arg7, _arg8, _arg9, _arg10);
  if (PyErr_Occurred()) {
    return NULL;
  }
